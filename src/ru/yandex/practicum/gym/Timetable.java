...
public class Timetable {
    ...
    private final HashMap<DayOfWeek, TreeMap<TimeOfDay, List<String>>> timetable = new LinkedHashMap<>();
    ...
    public void addNewTrainingSession(TrainingSession trainingSession) {
        ...
        TreeMap<TimeOfDay, List<String>> daySchedule = timetable.computeIfAbsent(day, k -> new TreeMap<>());
    ...
    public TreeMap<TimeOfDay, List<String>> getTrainingSessionsForDay(DayOfWeek dayOfWeek) {
